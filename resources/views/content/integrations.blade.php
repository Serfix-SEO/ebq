        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                ...
                <div class="min-w-0 flex-1">
                    <h2 class="text-sm font-bold text-slate-900 dark:text-slate-100">{{ __('Publishing to WordPress?') }}</h2>
                    <p class="mt-0.5 text-sm text-slate-500 dark:text-slate-400">{{ __('Install our WordPress plugin on your site to connect it and auto-publish your articles.') }}</p>
                </div>
