        ...
        <div class="mx-auto max-w-2xl space-y-6">
            ...
            <nav class="flex gap-1 rounded-2xl border border-slate-200/80 bg-slate-100/90 p-1 shadow-inner dark:border-slate-700/80 dark:bg-slate-800/60" role="tablist" aria-label="{{ __('Settings tabs') }}">
                <button type="button" role="tab" @click="tab = 'account'" :aria-selected="tab === 'account'"
                    ...
                    class="flex min-w-0 flex-1 items-center justify-center gap-2 rounded-xl px-3 py-2.5 text-sm font-semibold transition duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-100 dark:focus-visible:ring-offset-slate-800">
                    ...
                    <span class="truncate">{{ __('Account') }}</span>
                </button>
                <button type="button" role="tab" @click="tab = 'integrations'" :aria-selected="tab === 'integrations'"
                    ...
                    <span class="truncate">{{ __('Integrations') }}</span>
                </button>
