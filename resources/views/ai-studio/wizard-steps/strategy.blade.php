...
<div x-show="surface() === 'strategy'" class="space-y-4">
    ...
    <template x-if="!strategyHasAny()">
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800">
                ...
                <button type="button" @click="runStrategy(null)" :disabled="s.busyAll" class="rounded-lg bg-orange-600 px-4 py-2 text-sm font-semibold text-white hover:bg-orange-700 disabled:opacity-60" x-text="s.busyAll ? 'Building strategy…' : 'Generate strategy'"></button>
            </div>
        </div>
    </template>
    ...
    <template x-if="strategyHasAny()">
        <div class="space-y-3">
            ...
            <div class="flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800">
                <button type="button" @click="goToStep('brief')" class="rounded-lg px-4 py-2 text-sm font-semibold text-slate-500 hover:text-slate-700 dark:text-slate-400">← Back</button>
                <button type="button" @click="goToStep('images')" class="rounded-lg bg-orange-600 px-4 py-2 text-sm font-semibold text-white hover:bg-orange-700">Next: choose images →</button>
            </div>
        </div>
    </template>
</div>
