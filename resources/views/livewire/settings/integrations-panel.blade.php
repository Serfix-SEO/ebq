            ...
            <div class="px-5 py-4">
                ...
                <form wire:submit="saveSources" class="space-y-3">
                    ...
                    <div class="flex items-center justify-between border-t border-slate-100 pt-3 dark:border-slate-800">
                        <a href="{{ route('google.redirect', ['return' => 'settings.integrations']) }}" class="text-[11px] font-semibold text-orange-600 hover:text-orange-700 dark:text-orange-400">Missing a property? Connect another account</a>
                        <button type="submit" class="inline-flex h-8 items-center rounded-md bg-orange-600 px-3 text-xs font-semibold text-white shadow-sm transition hover:bg-orange-700">Save sources</button>
                    </div>
                </form>
            </div>
        </div>
