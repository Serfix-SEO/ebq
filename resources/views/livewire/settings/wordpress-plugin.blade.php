    ...
    <div class="flex items-start justify-between gap-4">
        <div class="min-w-0">
            ...
            <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                Download the Serfix SEO plugin, upload it to your WordPress site, then click <span class="font-semibold">Connect to Serfix</span> — you'll be bounced here to approve. No codes or tokens to copy.
            </p>
        </div>
    ...
    @if ($tokens->isEmpty())
        <div class="mt-5 flex flex-col items-start gap-2 rounded-lg border border-dashed border-slate-200 bg-slate-50/60 p-4 dark:border-slate-700 dark:bg-slate-800/40">
            ...
            <p class="text-xs text-slate-600 dark:text-slate-300">
                <span class="font-semibold">Download plugin</span> above, upload the ZIP to your site via <span class="font-semibold">Plugins → Add New → Upload</span>, activate <span class="font-semibold">Serfix SEO</span>, then click <span class="font-semibold">Connect to Serfix</span> — you'll be bounced back here to approve. Active connections will appear in this list.
            </p>
        </div>
    @else
        <div class="mt-5">
