    ...
    @if ($ppcEquivalent !== null)
        <div class="mb-3 flex items-center gap-2 rounded-lg border border-orange-200 bg-orange-50/60 px-4 py-2 text-xs text-orange-900 dark:border-orange-900/40 dark:bg-orange-500/5 dark:text-orange-200">
            ...
            <span>
                ...
                <span class="text-orange-600/70 dark:text-orange-300/70">· based on {{ number_format($ppcKeywordCount) }} priced queries</span>
            </span>
        </div>
    @endif
    ...
    <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        @php
            $cards = [
                ...
                ['key' => 'striking_distance', 'label' => 'Striking distance', 'tone' => 'orange', 'tab' => 'striking_distance', 'hint' => 'Pos 5–20 with low CTR', 'icon' => 'M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z'],
