                                ...
                                <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                    @foreach ($sheetRows as $i => $row)
                                        <tr wire:key="sheet-row-{{ $i }}" class="align-middle">
                                            ...
                                            <td class="p-1"><input wire:model.blur="sheetRows.{{ $i }}.domain_authority" type="number" min="0" max="100" class="h-8 w-full rounded border border-slate-200 bg-white px-2 text-right text-[11px] shadow-sm focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500/30 dark:border-slate-600 dark:bg-slate-800" /></td>
                                            <td class="p-1"><input wire:model.blur="sheetRows.{{ $i }}.spam_score" type="number" min="0" max="100" class="h-8 w-full rounded border border-slate-200 bg-white px-2 text-right text-[11px] shadow-sm focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500/30 dark:border-slate-600 dark:bg-slate-800" /></td>
                                ...
                                @foreach ($rows as $b)
                                    ...
                                    <tr @class([
                                        ...
                                        <td class="whitespace-nowrap px-2 py-1.5 text-right">
                                            ...
                                            <button type="button" wire:click="openSheetForDate('{{ $b->tracked_date->format('Y-m-d') }}')" class="rounded px-1.5 py-0.5 text-[10px] font-semibold text-orange-600 transition hover:bg-orange-50 dark:text-orange-400 dark:hover:bg-orange-500/10">Sheet</button>
