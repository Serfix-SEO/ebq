                    ...
                    @else
                        ...
                        <div class="mt-4 grid gap-4 lg:grid-cols-2">
                            ...
                            <div class="flex flex-col overflow-hidden rounded-2xl border border-orange-200 shadow-sm dark:border-orange-900">
                                ...
                                <div class="flex-1 overflow-x-auto [&::-webkit-scrollbar]:w-2.5 [&::-webkit-scrollbar-track]:bg-slate-50 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-slate-300 dark:[&::-webkit-scrollbar-track]:bg-slate-800 dark:[&::-webkit-scrollbar-thumb]:bg-slate-600">
