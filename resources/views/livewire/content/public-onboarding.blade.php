    ...
    @if ($capturingDomain)
        ...
        <div class="mx-auto max-w-2xl px-6 py-12 sm:py-16">
            <div class="rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-sm sm:p-10">
                ...
                <h1 class="mt-5 text-2xl font-extrabold tracking-tight text-slate-900">{{ __('Let’s set up your website') }}</h1>
                <p class="mx-auto mt-2 max-w-md text-sm text-slate-500">
                    {{ __('We write articles about your business and publish them on your website — so more people find you on Google.') }}
                </p>

                <div class="mx-auto mt-6 flex max-w-md flex-col gap-2 text-start text-sm text-slate-600 sm:flex-row sm:justify-center sm:gap-6">
                ...
                <form method="POST" action="{{ route('content.onboarding.begin') }}" class="mx-auto mt-7 max-w-md text-start">
                    @csrf
                ...
                @guest
                    ...
                    <div class="mt-6 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 border-t border-slate-100 pt-5 text-sm text-slate-500">
