<x-layouts.app>
    <div class="mx-auto w-full max-w-4xl space-y-6">
        ...
        <form method="POST" action="{{ route('admin.support.reply', $ticket) }}"
            ...
            <textarea name="body" rows="5" required minlength="2" maxlength="10000" placeholder="Write a reply…"
                class="mt-2 w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm shadow-sm focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">{{ old('body') }}</textarea>
